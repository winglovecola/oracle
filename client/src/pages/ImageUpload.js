...
function ImgUpload() {
  ...
  return (
    <div>
      ...
      <div id="user-photo-upload" classNAme="cards option">
        <form
          style={{ display: uploadFormShow ? 'block' : 'none' }}
          ...
          <input
            ...
            accept=".jpg"
            name="photos"
            onChange={setUserPhotoInputValue}
          />
        ...
        <div
          id="photo-uploaded-status"
          style={{ display: uploadStatusShow ? 'block' : 'none' }}>
          {photoUploadedStatus}
        </div>
        <div
          id="photo-uploading"
          style={{ display: uploadingDivShow ? 'block' : 'none' }}>
          <img
            src="/src/img/site/loading.gif"
            alt=""
            style={{ width: '50px' }}
          />{' '}
          Uploading
      ...
      <br />
      <br />
      <button className="button" type="button" onClick={editImageSubmit}>
        Edit Image
      </button>
