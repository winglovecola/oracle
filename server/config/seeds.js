  ...
  const products = await Product.insertMany([
     {
      name: 'Energy Bar',
      description:
        'Increase the limit of the fortune telling',
    ...
    },
    {
      name: 'Fortune Cookie',
      description:
        'Increase your luck and enjoy a yummy snack',
